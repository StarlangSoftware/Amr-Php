...
You can also see [Java](https://github.com/starlangsoftware/Amr) repository.
...
A directory called Amr will be created. Or you can use below link for exploring the code:

	git clone https://github.com/starlangsoftware/Amr-Php.git
